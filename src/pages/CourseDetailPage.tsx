      ...
      <section className="section-dark" style={{ paddingTop: 'calc(72px + 3rem)', paddingBottom: '3rem' }}>
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <div className="flex flex-wrap items-center gap-6 mt-4 text-sm" style={{ color: 'rgba(255,255,255,0.7)' }}>
              <span className="flex items-center gap-2">
                <Clock size={16} /> {course.duration}
              </span>
              <span className="flex items-center gap-2">
                <BookOpen size={16} /> {course.lessons} {t('coursedetail.lessons')}
              </span>
              <span className="flex items-center gap-2">
                <Award size={16} /> {t('coursedetail.level')}: {course.level}
              </span>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-10 lg:gap-14 items-start">
            ...
            <div className="flex flex-col gap-12">
                      ...
                      <div key={wk.week} className="card-light" style={{ padding: 0, overflow: 'hidden' }}>
                        ...
                        {isOpen && (
                          <div className="px-6 pb-5">
                            ...
                            <p className="flex items-start gap-2 text-xs font-semibold" style={{ color: '#D00000' }}>
              ...
              {/* Certificate */}
              <div className="card-light flex flex-col sm:flex-row items-center gap-6" style={{ backgroundColor: 'rgba(27,67,50,0.04)' }}>
                <div
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: '#6B5B4F' }}>
                    {t('coursedetail.certificate.desc')}
                  </p>
                </div>
              </div>
