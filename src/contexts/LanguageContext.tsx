...
const translations: Record<Lang, Record<string, string>> = {
  bn: {
    ...
    'coursedetail.certificate.desc': 'কোর্স সফলভাবে শেষ করার পর আপনি একটি সার্টিফিকেট পাবেন যা আপনার সিভিতে যুক্ত করতে পারবেন।',
  ...
  fr: {
    ...
    'coursedetail.certificate.desc': 'À la fin du cours, vous recevez un certificat de réussite à ajouter à votre CV.',
